...
class FusionModel(nn.Module):
    ...
    def forward(self, graph_data, sequence_data):
        ...
        sequence_embedding, reconstructed_sequence = self.sequence_model(sequence_data)
        sequence_embedding = sequence_embedding.to(self.device)
        reconstructed_sequence = reconstructed_sequence.to(self.device)

        reconstructed_sequence = reconstructed_sequence.squeeze()
        ...
        return output, reconstructed_sequence